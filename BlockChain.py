...
blockchain.mine(Block(information1))
blockchain.mine(Block(information2))
blockchain.mine(Block(information3))
blockchain.mine(Block(information4))
blockchain.mine(Block(information5))
blockchain.mine(Block(information6))
blockchain.mine(Block(information7))
blockchain.mine(Block(information8))
blockchain.mine(Block(information9))
blockchain.mine(Block(information10))
print("\n\n\n\n")
...
if(blockNoToEdit < 6):
    ...
    blockchain.head.data = informationEdited
